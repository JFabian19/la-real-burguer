...
export const DEFAULT_MENU_DATA: Category[] = [
  ...
  category('alitas', 'Alitas', [
    ...
    ['Alitas Hot Wings', 'S/. 19.00', 'Alitas extra picantes e irresistibles. (Táper S/. 1.00)'],
  ...
  category('salchipapas', 'Salchipapas', [
    ...
    ['Salchipollo Crispy', 'S/. 17.00', '(Táper S/. 1.00)'],
    ['Salchi Burger', 'S/. 18.50', '(Táper S/. 1.00)'],
    ['Salchi Pollo Real', 'S/. 21.50', '(Táper S/. 1.00)'],
    ['Camionero', 'S/. 27.00', '(Táper S/. 1.00)'],
  ]),
